...
YC_List={
	{"RTU/GGIO3.AnIn1", ".mag.f", "FLOAT32"}, --FLOAT, 1_TH_Sensor_Humidity
	{"RTU/GGIO3.AnIn2", ".mag.f", "FLOAT32"}, --FLOAT, 1_TH_Sensor_Temperature
	{"RTU/GGIO4.AnIn1", ".mag.f", "FLOAT32"}, --FLOAT, 1_TH_SensorTemperatureHumiditySensor_Humidity
	{"RTU/GGIO4.AnIn2", ".mag.f", "FLOAT32"}, --FLOAT, 1_TH_SensorTemperatureHumiditySensor_Temperature
};
...
YC_MB_List={
	...
	--1_TH_SensorTemperatureHumiditySensor
	{
		--4800,NoneParity,StopBit_1,Func "03",modbus addr 0x01,wait time 1000ms,package time 100ms
		com = {"BAUDRATE_4800","NoneParity","StopBit_1","03",0x01,1000,100},
		data =
