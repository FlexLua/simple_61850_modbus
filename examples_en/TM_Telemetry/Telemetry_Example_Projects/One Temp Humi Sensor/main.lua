...
MB_List = 
{
	-- Sensor #1
	{
		-- 4800, no parity, 1 stop bit, func "03", addr 0x01, timeout 100ms, gap 1000ms
	...
	for i, mb in ipairs(MB_List) do
		...
		do
			...
			if Finish == 1 then
				...
				else -- success, JSON like: {"RTU/GGIO1.AnIn1":28.12, ...}
...
-- set W5500 SPI pins MISO,MOSI,CLK,CS on D1,D2,D3,D4; RST on D5
