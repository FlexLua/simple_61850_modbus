...
{
	--1号变压器
	{"RTU/GGIO1.AnIn1", ".mag.f", "FLOAT32"}, --浮点小数类型, A相温度值
	{"RTU/GGIO1.AnIn2", ".mag.f", "FLOAT32"}, --浮点小数类型, B相温度值
	{"RTU/GGIO1.AnIn3", ".mag.f", "FLOAT32"},  --浮点小数类型, C相温度值
	{"RTU/GGIO1.Inc1", ".stVal", "INT32"}, --整数类型, A相温度传感器信号强度值
	{"RTU/GGIO1.Inc2", ".stVal", "INT32"}, --整数类型, B相温度传感器信号强度值
	{"RTU/GGIO1.Inc3", ".stVal", "INT32"}  --整数类型, C相温度传感器信号强度值
...
MB_List = 
{
	--1号变压器
	{
		...
		data = 
		{
			{"RTU/GGIO1.AnIn1",0x0030,"U_AB",2}, --A相温度, 2位小数(实际上是U_AB整数乘以0.01)
			{"RTU/GGIO1.AnIn2",0x0031,"U_AB",2}, --B相温度, 2位小数(实际上是U_AB整数乘以0.01)
			{"RTU/GGIO1.AnIn3",0x0032,"U_AB",2}, --C相温度, 2位小数(实际上是U_AB整数乘以0.01)
			{"RTU/GGIO1.Inc1",0x0060,"U_AB",2}, --A相信号强度, 整数
			{"RTU/GGIO1.Inc2",0x0061,"U_AB",2}, --B相信号强度, 整数
			{"RTU/GGIO1.Inc3",0x0062,"U_AB",2}  --C相信号强度, 整数
		}
	}
}
