...
YC_List = 
{
	...
	--3号温湿度传感器
	{"RTU/GGIO3.AnIn1", ".mag.f", "FLOAT32"}, --浮点小数类型, 湿度
	{"RTU/GGIO3.AnIn2", ".mag.f", "FLOAT32"}  --浮点小数类型, 温度
}
...
MB_List = 
{
	...
	--3号温湿度传感器
	{
		--4800,无校验,1位停止位,功能码"03",modbus地址0x03,应答最长等待100ms,分包间隔时间1000ms
		com = {"BAUDRATE_4800","NoneParity","StopBit_1","03",0x03,100,1000},  
		data = 
		{
			{"RTU/GGIO3.AnIn1",0x0000,"S_AB",1}, --湿度, 1位小数(实际上是S_AB类型整数乘以0.1)
			{"RTU/GGIO3.AnIn2",0x0001,"S_AB",1}  --温度, 1位小数(实际上是S_AB类型整数乘以0.1)
		}
	}
}
